...
public class FacesBufferList {
    ...
    public FacesBufferList(ShortBuffer b, int size)
    {
    ...
    public FacesBufferList(int maxElements)
    {
    ...
    public FacesBufferList clone()
    {
        _b.position(0);
        FacesBufferList c = new FacesBufferList(_b, size());
        return c;
    }
}