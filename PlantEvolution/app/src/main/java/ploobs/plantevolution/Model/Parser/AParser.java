    ...
    protected class TextureAtlas {
        ...
        public void addBitmapAsset(BitmapAsset ba) {
            ...
            if(existingBA == null)
            {
                ...
                if(bmResourceID == 0)
                {
                    Log.d(PlantEvolution.TAG, "Texture not found: " + ba.resourceID);
                    return;
                }

                Log.d(PlantEvolution.TAG, "Adding texture " + ba.resourceID);
        ...
        public void generate() {
			...
			*/
            setId(TextureManager.getInstance().getNewAtlasId());
        }
