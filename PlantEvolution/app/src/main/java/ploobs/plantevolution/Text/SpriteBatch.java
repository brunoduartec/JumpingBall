...
public class SpriteBatch {
    ...
    //--Members--//
    TextVertex vertices;                                 // Vertices Instance Used for Rendering
    ...
    public SpriteBatch(int maxSprites, Program program)  {
        ...
        this.vertices = new TextVertex(maxSprites * VERTICES_PER_SPRITE, maxSprites * INDICES_PER_SPRITE);  // Create Rendering Vertices
